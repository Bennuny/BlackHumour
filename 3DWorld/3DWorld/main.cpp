...
const GLuint        WIN_WIDTH = 1280;
const GLuint        WIN_HEIGHT = 720;
...
//    ImGui::StyleColorsClassic();
    ...
    ThreeDWorld threeWorld(WIN_WIDTH, WIN_HEIGHT);
...
//            ImGui::SetWindowPos(ImVec2(display_w - ImGui::GetWindowWidth(), display_h - ImGui::GetWindowHeight()));
//            ImGui::End();
//        }
